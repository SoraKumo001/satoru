...
const char* satoru_master_css =
    ...
    "p, dl, multicol, menu, ol, ul { display: block; margin-block-start: 1em; margin-block-end: 1em; }\n"
    ...
    "hr { display: block; margin-block-start: 0.5em; margin-block-end: 0.5em; margin-inline-start: auto; margin-inline-end: auto; border-style: inset; border-width: 1px; }\n"
    ...
    "h4 { display: block; font-size: 1em; font-weight: bold; margin-block-start: 1.33em; margin-block-end: 1.33em; }\n"
    "h5 { display: block; font-size: .83em; font-weight: bold; margin-block-start: 1.67em; margin-block-end: 1.67em; }\n"
    "h6 { display: block; font-size: .67em; font-weight: bold; margin-block-start: 2.33em; margin-block-end: 2.33em; }\n"
    "button {\n"
