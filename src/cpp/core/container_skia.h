...
class container_skia : public litehtml::document_container {
   ...
   public:
    ...
    const std::vector<conic_gradient_info>& get_used_conic_gradients() const { return m_usedConicGradients; }
    ...
    virtual litehtml::element::ptr create_element(const char *tag_name, const litehtml::string_map &attributes, const std::shared_ptr<litehtml::document> &doc) override { return nullptr; }
};
